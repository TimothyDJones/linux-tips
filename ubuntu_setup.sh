...
APP_EXT=AppImage
FILE_NAME=${APP_NAME,,}-${APP_VERSION}
sudo apt-get install -y libnotify-bin python3-pip python3-dulwich python3-pyqt5.qtquick qml-module-qtquick-controls
