...
curl -o /tmp/cudatext.deb -J -L https://cytranet.dl.sourceforge.net/project/cudatext/release/Linux/cudatext_1.8.0.0-1_gtk2_amd64.deb
...
curl -o /tmp/otter-browser.tar.gz -J -L https://iweb.dl.sourceforge.net/project/otter-browser/otter-browser-weekly171/otter-browser-0.9.91-dev171.tar.bz2
cd /tmp
dtrx -n /tmp/otter-browser.tar.gz
cd /tmp/otter-browser/otter-browser-0.9.91-dev171
mkdir build && cd build
cmake .. && make && sudo make install
cd $HOME
